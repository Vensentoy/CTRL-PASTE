                    ...
                    @foreach ($weeks as $week)
                        ...
                        <div class="p-4 text-sm">
                            <div class="flex items-center gap-3 mb-2">
                                <span class="w-16 text-gray-500">Week {{ $week }}</span>
                                <span class="flex-1">{{ $war->{"week{$week}_activities"} }}</span>
                                <span class="w-16 text-right">{{ number_format($war->{"week{$week}_hours"}, 2) }}h</span>
                                <span @class([
