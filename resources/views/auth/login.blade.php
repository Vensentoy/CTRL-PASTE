{{-- QR-gated access: login form only renders when session has qr_verified_at (set via GET /qr/enter with signed one-time token generated by coordinator). Direct URL typing without scanning shows no form. --}}
<x-guest-layout>
