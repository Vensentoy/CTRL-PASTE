<x-guest-layout>
    <div class="text-center py-8">
        ...
        <p class="mt-2 text-sm text-gray-600">This site is available only via a coordinator-generated QR code. Point your camera at the QR and tap the link banner that appears — it will open the login form automatically. Ask your coordinator to click <span class="font-medium">Generate QR</span> on their dashboard.</p>
