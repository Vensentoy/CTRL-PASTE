...
| activities_text | free text |
| time_started, time_ended | raw inputs |
| hours_rendered | ALWAYS derived = time_ended − time_started (BR-3), never accepted as direct input |
...
| week{1..4}_activities, week{1..4}_hours, week{1..4}_status, week{1..4}_comment | each week reviewed independently (BR-7) |
